...
import UpdateMandatoryForm from "../../Components/Forms/UpdateMandatoryandSignature";
...
export default function MandateandSignature() {
  ...
  const handleVerifyOTP = () => {
    ...
    axios
      ...
      .then((newResponse) => {
        ...
        dispatch(setAccountOpeningStep(`mandate-and-sign`));
      })
      .catch((err) => {
        console.log(err);
        setValidating(false);
              ...
              <div className="d-flex flex-column pt-5">
                <div className="d-flex justify-content-end">
                  ...
                  <h1 className="pr-3 mb-4 text-capitalize">
                    Change of mandate and signature
                  </h1>
                </div>
                <nav className="mb-4">
