...
function DocumentUploadDialog(props: any) {
  ...
  const uploadDocuments = () => {
    disatch(setStep("account-opening-success"));
  };
      ...
      <div className=' card-form px-2'>
        <div className='card-body'>
          ...
          <p className='text-center'>
            <small>
              The file format should be JPEG, PNG or PDF (max size:2mb)
            </small>
          </p>
          ...
          <div className='row mr-3'>
            ...
            <div className='col-lg-3'>
              <div className='col-md-3'>
                <label htmlFor='firstname' className='label_text2 text-nowrap'>
                  Take/Upload live picture
                </label>
                <div className='pic_upload d-flex justify-content-between pt-3 pr-3 px-2'>
                  <p className='label_text'>
                    Click or drag <br /> and drop file
          ...
          <div className='row mt-3 ml-1'>
            <div className='col form-group'>
              <label htmlFor='branch domicilation' className='label_text'>
                Branch of account domiciliation
              </label>
              <select
                ...
                <option value='yes' className=''>
                  Select branch of account domiciliation
                </option>
              </select>
            </div>
          </div>
          ...
          <div className='row mt-3 ml-1'>
            <label htmlFor='branch domicilation' className='label_text mb-3'>
            ...
            <div className='custom-control custom-checkbox checkbox-lg input-group mb-2'>
              ...
              />
              <label className='custom-control-label pl-2' htmlFor='checkbox1'>
                Debit card (Verve)
              </label>
            </div>
            <div className='custom-control custom-checkbox checkbox-lg input-group mb-2'>
              <input
                ...
                style={{ marginRight: "10px" }}
              />
              <label className='custom-control-label pl-2' htmlFor='checkbox2'>
                SMS alert
              </label>
            </div>
            <div className='custom-control custom-checkbox checkbox-lg input-group mb-2'>
              <input
                ...
                style={{ marginRight: "10px" }}
              />
              <label className='custom-control-label pl-2' htmlFor='checkbox3'>
                Email alert
              </label>
            </div>
            <div className='custom-control custom-checkbox checkbox-lg input-group mb-2'>
        ...
        <div className='d-flex justify-content-end mt-2'>
          <div className='mb-3 mr-4' style={{ marginRight: "20px" }}>
            <button className='btn btn-outline-danger mr-3 btn-filled-white'>
              Previous
            </button>
          </div>
          <div className='ml-4'>
            <button
              type='submit'
              className='btn btn-danger btn-filled-red'
