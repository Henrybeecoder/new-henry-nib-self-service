...
function UpdateDetailJointCurrentDialog(props:any) {
    return (
        <div>
          <div className="card-body">
              ...
              <div className="form-group mb-4">
                <label htmlFor="branch domicilation" className="label_text">Currencies of account to be
                  opened</label>
                {/* <div className="btn border-dark  text-muted currency-list2" id="checkCurrency" onclick="showDiv()"> */}
                <div className="btn border-dark  text-muted currency-list2" id="checkCurrency">
                  <span>Select currency</span>
                  <div className="ngn" id="dvNgn"><img src="./images/ngn.svg" alt=""/><img src="./images/usd.svg" alt=""/>
                  </div>
                  <div><img src="./images/black_drop_down_icon.svg" alt="" /></div>
                </div>
                <div className="currency-div2 mt-1 pt-2 mr-auto alert" id="welcomeDiv">
                  <div className="custom-control custom-checkbox input-group mb-2 ml-3">
                    {/* <input type="checkbox" className="custom-control-input" id="checkbox01" onclick="curList()" /> */}
                    <input type="checkbox" className="custom-control-input" id="checkbox01" />
                    <label className="custom-control-label pl-3" htmlFor="checkbox01">NGN</label>
                  </div>
                  <hr className="m-0" />
                  <div className="custom-control custom-checkbox input-group mb-2 ml-3">
                    <input type="checkbox" className="custom-control-input" id="checkbox02" />
                    <label className="custom-control-label pl-3" htmlFor="checkbox02">USD</label>
                  </div>
                  <hr className="m-0" />
                  <div className="custom-control custom-checkbox input-group mb-2 ml-3">
                    <input type="checkbox" className="custom-control-input" id="checkbox03" />
                    <label className="custom-control-label pl-3" htmlFor="checkbox03">EURO</label>
                  </div>
                  <hr className="m-0" />
                  <div className="custom-control custom-checkbox input-group mb-2 ml-3">
                    <input type="checkbox" className="custom-control-input" id="checkbox04" />
                    <label className="custom-control-label pl-3" htmlFor="checkbox04">GBP</label>
                  </div>
                </div>
              </div>
              ...
              <label htmlFor="residentialaddress" className="label_text mb-2 font-weight-bold">Residential address</label>
...
export default UpdateDetailJointCurrentDialog;