...
function UpdateDetailCurrentDialog(props: any) {
    return (
        <div>
            <div className="card-body">
                ...
                <div className="row mt-3 mb-4">
                    <div className="col form-group">
                        ...
                        <select className="form-control border-dark bg-white" name="branch" id="">
                            <option value="yes" className="">Select Christianity</option>
                        </select>
                ...
                <div className=" row d-flex form-group mb-4">
                    <div className="col-lg-6">
...
export default UpdateDetailCurrentDialog;