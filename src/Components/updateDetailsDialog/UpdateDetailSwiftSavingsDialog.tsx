...
function UpdateDetailSwiftSavingsDialog(props: any) {
  ...
  const updateDetails = () => {
    disatch(setStep("document-upload"));
  };
    ...
    <div>
      <div className=' card-form pl-1 pr-1 '>
        <div className='card-body'>
          ...
          <p className='text-center pl-5 no-wrap'>
            Hello{" "}
          ...
          <div className='bvn_val mb-4' id='fader'>
            ...
            <small className='text-danger ml-4 font-weight-bold'>
              <b>Update your address and email if it has changed</b>
            </small>
          </div>
          <div className='row'>
            ...
            <div className='col-sm-8 mt-4 pt-2 sec'>
              <div className='row form-row mb-3'>
                ...
                <div className='col-lg-6'>
                  <label htmlFor='secondname' className='label_text'>
                    Secondname
                  </label>
                  <input
                    type='text'
              ...
              <div className='row form-row mb-3'>
                ...
                <div className='col-lg-6'>
                  <label htmlFor='dateofbirth' className='label_text'>
                    Date of birth
                  </label>
                  <input
                    type='text'
                    className='form-control bg-white border-dark'
                    placeholder='12-04-1989'
                  />
                </div>
              </div>
            </div>
          ...
          <div className=' row form-group d-flex mb-4'>
            <div className='col-lg-6'>
              <label htmlFor='religion' className='label_text'>
                Religion
              </label>
            ...
            <div className='col-lg-6 mr-0'>
              <label htmlFor='occupation' className='label_text'>
                Occupation
              </label>
              <select className='form-control border-dark'>
          ...
          <div className='form-group mb-4'>
            <input
              className='form-control sec border-dark'
              type='text'
              id='address'
          ...
          <div className='form-group mb-4'>
            <label htmlFor='refferalcode' className='label_text'>
          ...
          <div>
            <div className='d-flex justify-content-end mt-4'>
              <button
                ...
                className='btn btn-outline-danger btn-filled-white'>
                Previous
              </button>
              <button
                type='submit'
