...
function UpdateDetailDomiciliaryCurrentDialog(props:any) {
    return (
        <div>
            <div className="card-body">
              ...
              <label htmlFor="residentialaddress" className="label_text my-2 mt-4 font-weight-bold"><b>Residential address</b></label>
              ...
              <div className="row mt-4 mb-4">
                <div className="col form-group">
                  ...
                  <select className="form-control border-dark bg-white pt-2 pb-3" name="branch" id="">
...
export default UpdateDetailDomiciliaryCurrentDialog;